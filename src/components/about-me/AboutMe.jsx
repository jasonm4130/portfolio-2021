    ...
    <div className={aboutMeContainer}>
      ...
      <div className={aboutMeContent}>
        ...
        <p>
          ...
          Starting as a freelancer working with start-ups and local businesses.
          I love coding and learning about the latest trends. With a particular
          focus on the current JavaScript ecosystem, and a traditional knowledge
          of PHP through WordPress and MVC frameworks like SilverStripe, Code
          Ignitor and Laravel.
        </p>
        <p>
        ...
        <p>
          I am a avid learner and I put a high priority on this attending local
          meetups whenever possible, while also seeking learning through online
          courses and personal projects.
        </p>
        <p>
          When outside of work I enjoy Learning including running two servers at
          home to experience more server architecture, networks and deployment
          methods.
        </p>
        <p>
